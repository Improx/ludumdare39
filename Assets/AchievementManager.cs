...
public partial class AchievementManager : MonoBehaviour
{
    ...
    public static readonly List<AchievementInfo> Achievements = new List<AchievementInfo>
    {
        ...
        new AchievementInfo(Achievement.TWITTER_BOTS_100, 100, AchColors[AchSpriteColor.Blue], "If I知 going to clean house, they will come in as fresh blood", "Buy 100 Twitter bots", 4),
        ...
        new AchievementInfo(Achievement.FIRE_PEOPLE_200, 200, AchColors[AchSpriteColor.Red], "If I知 going to clean house, they will come in as fresh blood", "Fire 200 people", 6),
        ...
        new AchievementInfo(Achievement.FAKE_AUDIENCE_100, 100, AchColors[AchSpriteColor.Blue], "If I知 going to clean house, they will come in as fresh blood", "Use fake audience 100 times", 4),
        ...
        new AchievementInfo(Achievement.ANTI_LGBT_100, 100, AchColors[AchSpriteColor.Blue], "If I知 going to clean house, they will come in as fresh blood", "Hate on transgender 100 times", 4),
        ...
        new AchievementInfo(Achievement.RICH_FRIENDS_100, 100, AchColors[AchSpriteColor.Blue], "If I知 going to clean house, they will come in as fresh blood", "Helped 100 rich friend", 4),
        ...
        new AchievementInfo(Achievement.SOLDIERS_100, 100, AchColors[AchSpriteColor.Blue], "If I知 going to clean house, they will come in as fresh blood", "Invest in soldiers 100 times", 4),
        ...
        // Wall bricks
        new AchievementInfo(Achievement.WALL_1, 1, AchColors[AchSpriteColor.Bronze], "You're fired!", "Start building the Wall", 1),
        new AchievementInfo(Achievement.WALL_10, 10, AchColors[AchSpriteColor.Silver], "Get out!", "Stack 10 bricks on the Wall", 1),
        new AchievementInfo(Achievement.WALL_50, 50, AchColors[AchSpriteColor.Gold], "Who are these people?", "Stack 50 bricks on the Wall", 2),
        new AchievementInfo(Achievement.WALL_100, 100, AchColors[AchSpriteColor.Blue], "If I知 going to clean house, they will come in as fresh blood", "Stack 100 bricks on the Wall", 4),
        new AchievementInfo(Achievement.WALL_200, 200, AchColors[AchSpriteColor.Red], "Grab them by the p*ssy", "Stack 200 bricks on the Wall", 6),
